...
function loadKPI(json) {
    document.getElementById("confirmed").innerHTML = json.Global.TotalConfirmed.toLocaleString("PT-BR");
    document.getElementById("death").innerHTML = json.Global.TotalDeaths.toLocaleString("PT-BR");
    document.getElementById("recovered").innerHTML = json.Global.TotalRecovered.toLocaleString("PT-BR");
